            ...
            <form onSubmit={handleEditSubmit} style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
              ...
              <div>
                ...
                >
                  <button
                    type="button"
                    onClick={() => setEditingChallenge({ ...editingChallenge, type: "coding" })}
                    style={{
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      ...
                      background:
                        editingChallenge.type === "coding"
                          ? "linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)"
                          : "transparent",
                      color: editingChallenge.type === "coding" ? "#ffffff" : "#94a3b8",
                      boxShadow:
                        editingChallenge.type === "coding" ? "0 4px 12px rgba(99, 102, 241, 0.3)" : "none",
                    }}
                  >
                    <Code2 size={18} />
                    <span>Coding</span>
                  ...
                  <button
                    type="button"
                    onClick={() => setEditingChallenge({ ...editingChallenge, type: "mcq" })}
                    style={{
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      ...
                      background:
                        editingChallenge.type === "mcq"
                          ? "linear-gradient(135deg, #06b6d4 0%, #3b82f6 100%)"
                          : "transparent",
                      color: editingChallenge.type === "mcq" ? "#ffffff" : "#94a3b8",
                      boxShadow:
                        editingChallenge.type === "mcq" ? "0 4px 12px rgba(6, 182, 212, 0.3)" : "none",
                    }}
                  >
                    <HelpCircle size={18} />
                    <span>MCQ</span>
